...
public class Lvl03_2 extends Level {
	...
	public void register(World world) {
     ...
     // Register a new instance, to restart level automatically
        world.setNextLevel(new Lvl03_2());
     ...
     // Construct terrain
        ...
        world.register(new Terrain(110,3.5,3,5,"snow"));
        ...
        world.register(new Block(105,32,2,1,"stone.1"));
        ...
        Player player = new Player(new Vector(130,3));
        ...
        world.register(new Mover(new Vector(10,4), 2, 7, new Vector(130,4), "stone.7", torch, 3.0));
