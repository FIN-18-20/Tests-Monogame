...
public class Lvl04 extends Level {
	...
	public void register(World world) {
     ...
     // Construct terrain
        ...
        world.register(new Door(31,34,"blue",new Or(yellow3, new Or(yellow1,new Or(yellow4, new Or(yellow5,new Or(yellow6,new Or(yellow8, yellow7))))))));
        world.register(new Door(32,34,"blue",new Or(yellow3, new Or(yellow1,new Or(yellow4, new Or(yellow5,new Or(yellow6,new Or(yellow8, yellow7))))))));
        world.register(new Door(27,34,"blue",new Or(yellow3, new Or(yellow1,new Or(yellow4, new Or(yellow5,new Or(yellow6,new Or(yellow8, yellow7))))))));
        world.register(new Door(26,34,"blue",new Or(yellow3, new Or(yellow1,new Or(yellow4, new Or(yellow5,new Or(yellow6,new Or(yellow8, yellow7))))))));
        world.register(new Door(29,34,"blue",new Or(yellow3, new Or(yellow1,new Or(yellow4, new Or(yellow5,new Or(yellow6,new Or(yellow8, yellow7))))))));
        world.register(new Door(28,34,"blue",new Or(yellow3, new Or(yellow1,new Or(yellow4, new Or(yellow5,new Or(yellow6,new Or(yellow8, yellow7))))))));
        world.register(new Door(30,34,"blue",new Or(yellow3, new Or(yellow1,new Or(yellow4, new Or(yellow5,new Or(yellow6,new Or(yellow8, yellow7))))))));
        world.register(new Laser(26,33.5,7,"h",new Constant()));
        
        world.register(new Exit(95,35.25,new Lvl_Select(), new Constant()));
        world.register(new Checkpoint(35,36,10, new Lvl04_1()));
        ...
        Player player = new Player(new Vector(11,35));
        ...
        world.register(new Mover(new Vector(-4,41.5),8,3,new Vector(-4,1500),"stone.2", torch1,0.25));
	}
}
