...
public class Lvl03 extends Level {
	public void register(World world) {
        super.register(world);
        
     // Register a new instance, to restart level automatically
        world.setNextLevel(new Lvl03());
     ...
     // Construct terrain
        ...
        world.register(new Terrain(47,1.2,1,8,"snow"));
        ...
        world.register(new Checkpoint(93,2,12,new Lvl03_1())); //checkpoint1
        ...
        world.register(new Checkpoint(130,3,10,new Lvl03_2()));//checkpoint2
        ...
        Player player = new Player(new Vector(11,1));
        ...
        world.register(new Mover(new Vector(9.5,4), 2, 7, new Vector(130,4), "stone.7", torch, 3.0));
